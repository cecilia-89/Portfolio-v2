              ...
              <div className="group relative grid gap-4 pb-1 transition-all sm:grid-cols-8 sm:gap-8 md:gap-4 lg:hover:!opacity-100 lg:group-hover/list:opacity-50">
                ...
                <div className="z-10 sm:order-2 sm:col-span-6">
                  ...
                  <p className="mt-2 text-sm leading-normal text-justify">
                    I earned a <b>Bachelor&apos;s degree in Software Engineering</b> from
                    ...
                    Java, and Python, and gained proficiency in <b>object-oriented
                    programming (OOP), data structures, algorithms, SDLC, and
                    web development</b>. I also acquired knowledge in <b>database
                    management, version control using Git, and software testing,
                    while honing communication and teamwork abilities</b>.
                  </p>
                </div>
                <img
                  alt=""
